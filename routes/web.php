...
Route::middleware(['authh', 'validaEmpresa'])->group(function () {
    ...
    Route::get('imei-tracking', 'ImeiTrackingController@index')->name('imei-tracking.index');
        ...
        Route::get('conta-receber-download-file/{id}', 'ContaReceberController@imprimirComprovante')->name('conta-receber.imprimir-comprovante');
        Route::get('conta-receber-imprimir-comprovante/{id}', 'ContaReceberController@estornar')->name('conta-receber.estornar');
