...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'unidade' => ['sometimes', 'required', 'string'],
            'cst_csosn' => ['sometimes', 'required', 'string'],
            'cst_pis' => ['sometimes', 'required', 'string'],
            'cst_cofins' => ['sometimes', 'required', 'string'],
            'cst_ipi' => ['sometimes', 'required', 'string'],
            'valor_unitario' => ['sometimes', 'required'],
            // Alterar tracking_type pode exigir regras adicionais em fases futuras.
            'tracking_type' => [
                'sometimes',
                'required',
                'string',
            ...
            'referencia_balanca' => [new ValidaReferenciaBalanca($this->empresa_id ?? null)],
        ];
    }
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator): void {
            ...
            $hasVariantsProvided = $this->has('has_variants');
            ...
            if ($hasVariantsProvided && $hasVariants && $trackingType && $trackingType !== Produto::TRACKING_TYPE_VARIANT) {
