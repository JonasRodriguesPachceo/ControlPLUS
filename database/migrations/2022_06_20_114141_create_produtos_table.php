...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('produtos', function (Blueprint $table) {
            ...
            $table->decimal('pICMSEfet', 5,2)->nullable();
            $table->decimal('pRedBCEfet', 5,2)->nullable();
            ...
            $table->decimal('perc_ibs_uf', 10,2)->default(0);
            $table->decimal('perc_ibs_mun', 10,2)->default(0);
            $table->decimal('perc_cbs', 10,2)->default(0);
            $table->decimal('perc_dif', 10,2)->default(0);
