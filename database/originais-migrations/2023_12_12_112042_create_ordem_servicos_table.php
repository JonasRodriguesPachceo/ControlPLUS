...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ordem_servicos', function (Blueprint $table) {
            ...
            $table->string('tipo_servico', 30)->nullable(); //ex: "reparo", "manutenção", "instalação"
            $table->text('diagnostico_cliente');
            $table->text('diagnostico_tecnico');
            $table->text('defeito_encontrado');

            $table->string('equipamento', 100)->nullable();
            $table->string('numero_serie', 100)->nullable();
            $table->string('cor', 30)->nullable();
            $table->boolean('faturada')->default(0);
