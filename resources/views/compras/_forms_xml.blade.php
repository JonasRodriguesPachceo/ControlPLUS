                            ...
                            <table class="table table-dynamic table-produtos">
                                ...
                                <tbody>
                                    ...
                                    <tr class="dynamic-form line_{{$key}}">
                                        ...
                                        <td>
                                            <input style="width: 120px" value="{{ __moedaInput($prod->valor_unitario + ($prod->valor_unitario * $lucroPadraoProduto)/100) }}" class="form-control moeda valor_venda" type="tel" name="valor_venda[]" id="inp-valor_unitario">
                                        </td>
                                        <td>
