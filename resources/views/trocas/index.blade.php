                        ...
                        <table class="table table-striped table-centered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td data-label="Venda ID">{{ $item->nfce ? $item->nfce->numero_sequencial : '' }}</td>
                                    ...
                                    <td>
                                        <form action="{{ route('trocas.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" style="width: 320px">
                                            ...
                                            <a target="_blank" class="btn btn-dark btn-sm" title="Imprimir" href="{{ route('trocas.imprimir', $item->id) }}">
