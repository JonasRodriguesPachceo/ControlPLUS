            ...
            <li class="side-nav-item" id="step7">
                ...
                <div class="collapse" id="sidebarExtendedProd">
                    <ul class="side-nav-second-level">
                        ...
                        @can('unidade_medida_view')
                        <li>
                            <a href="{{ route('custo-configuracao.index') }}">Configuração de custo</a>
                        </li>
                        @endcan
            ...
            <li class="side-nav-item" id="step6">
                ...
                <div class="collapse" id="sidebarUsuarios">
                    <ul class="side-nav-second-level">
                        ...
                        <li>
                            <a href="{{ route('usuarios.historico-acesso') }}">Histórico de acesso</a>
                        </li>
                        @endcan
                        ...
                        <li>
                            ...
                            <div class="collapse" id="pagar">
                                <ul class="side-nav-third-level">
                                    @can('conta_pagar_view')
                                    <li>
                                        <a href="{{ route('fechamento-mensal.historic') }}">Histórico</a>
                                    </li>
                                    @endcan

                                    @can('conta_pagar_create')
                                    <li>
                                        <a href="{{ route('fechamento-mensal.index') }}">Nova fechamento</a>
                                    </li>
                                    @endcan
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarIfood">
                    <ul class="side-nav-second-level">
                        ...
                        <!-- <li>
                            <a href="{{ route('ifood-funcionamento.index') }}">Funcionamento</a>
                        </li> -->
