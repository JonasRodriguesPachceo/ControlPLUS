...
<div class="card mt-1">
    <div class="card-header">
        ...
        <div style="text-align: right; margin-top: -35px;">
            <a href="{{ route('padrao-tributacao-produto-super.index') }}" class="btn btn-danger btn-sm px-3">
    ...
    <div class="card-body">
        {!!Form::open()->fill($item)
        ->put()
        ->route('padrao-tributacao-produto-super.update', [$item->id])
        !!}
        <div class="pl-lg-4">
            @include('padrao_tributacao_super._forms')
        </div>
        {!!Form::close()!!}
    </div>
</div>
