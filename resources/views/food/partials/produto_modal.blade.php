								...
								<div class="comprar">
									...
									<div id="botoes_fim" class="line botoes">
										<div class="row">
											...
											@endif
											<div class="col-md-6">
												<button type="button" @if($tipoPizza) disabled @endif class="sacola-adicionar botao-acao pull-right"><i class="icone icone-sacola"></i> <span>Adicionar a sacola</span></button>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
